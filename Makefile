...
LIBRARY_SUBDIR_LIST= seos wolfssl $(shell ls $(LIBRARY_SOURCE_PATH) --hide=seos --hide=wolfssl) #确保seos库是第一个编译的library
$(warning LIBRARY_SUBDIR_LIST= $(LIBRARY_SUBDIR_LIST))
LIBRARY_CONFIG_SUBDIR=$(LIBRARY_SUBDIR_LIST)
LIBRARY_C_SUBDIR_LIST= seos wolfssl $(shell ls $(LIBRARY_SOURCE_C_PATH) --hide=seos --hide=wolfssl) #确保seos库是第一个编译的library
