...
int paypass_clean(unsigned char * CleanData, uint32_t * size, int * IsLast);
int paypass_torn_record_delete_all(void);

int paypass_msg_signal_data_get(unsigned char * buff, uint32_t * size);
int paypass_final_trans_data_get(unsigned char * buff, uint32_t * size);
