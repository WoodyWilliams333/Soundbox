...
int  visa_drl_get(uint32_t data_index, struct visa_drl_item * drl);



void visa_terminal_aid_clear(void);
int  visa_terminal_aid_add(const struct visa_terminal_aid *info);
int  visa_terminal_aid_get(int data_index, struct visa_terminal_aid *info);
...
typedef int  (*fn_callback_visa_terminal_aid_get)(int data_index, void * pAidInfo, uint32_t *puiSize);
...
typedef int (*fn_visa_detect_broken)(uint32_t DetectHandle); //If broken detected, return none zero
void visa_set_broken_detect_func(fn_visa_detect_broken  pFn_DetectBroken, uint32_t DetectHandle);
...
int visa_msd_get_track1(char * pTrack1, uint32_t uiSize);
int visa_msd_get_track2(char * pTrack2, uint32_t uiSize);
int visa_get_terminal_entry_capability(char * pszEntryCapability, uint32_t uiSize);
