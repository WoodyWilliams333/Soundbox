...
#define exit(x)	do { printf("here should exit(%d) ... goto sleep long time instaed !!!\r\n", x);  while (1) Sleep(1000);} while (0)
...
/* wolfSSL */
#ifndef TEST_IPV6
    static const char* const wolfSSLIP   =  "10.1.23.179";//"121.15.134.226";
#else
    static const char* const wolfSSLIP   = "::1";
#endif
static const word16      wolfSSLPort = 8000;
...
#if 0 // !defined(WOLFSSL_MDK_ARM) && !defined(WOLFSSL_KEIL_TCP_NET) && !defined(WOLFSSL_TIRTOS)
