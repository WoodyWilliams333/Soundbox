...
WOLFSSL_API void wolfSSL_BN_bn2dec_free(char *buf);
...
WOLFSSL_API unsigned long wolfSSL_BN_get_word(const WOLFSSL_BIGNUM* bn);
...
#define BN_bn2dec_free wolfSSL_BN_bn2dec_free
