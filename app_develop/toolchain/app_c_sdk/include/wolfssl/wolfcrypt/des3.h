...
// for DES2 (16 bytes 3DES) ///////////////////////////////////////////////////////
WOLFSSL_API int  wc_Des2_SetKey(Des3* des, const byte* key,
                                const byte* iv,int dir);
WOLFSSL_API int  wc_Des2_SetIV(Des3* des, const byte* iv);
WOLFSSL_API int  wc_Des2_CbcEncrypt(Des3* des, byte* out,
                                    const byte* in,word32 sz);
WOLFSSL_API int  wc_Des2_CbcDecrypt(Des3* des, byte* out,
                                    const byte* in,word32 sz);
WOLFSSL_API int  wc_Des2Init(Des3*, void*, int);
WOLFSSL_API void wc_Des2Free(Des3*);
