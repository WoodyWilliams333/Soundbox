...
#include <wolfssl/wolfcrypt/types.h>
    ...
    extern "C" {
        ...
        WOLFSSL_API void* _wolfSSL_Malloc(const char*file, int line, size_t size);
        WOLFSSL_API void  _wolfSSL_Free(const char*file, int line, void *ptr);
        WOLFSSL_API void* _wolfSSL_Realloc(const char*file, int line, void *ptr, size_t size);
        #define wolfSSL_Malloc(n)           _wolfSSL_Malloc(__FILE__, __LINE__, (n))
        #define wolfSSL_Free(ptr)           _wolfSSL_Free(__FILE__, __LINE__, (ptr))
        #define wolfSSL_Realloc(ptr, n)     _wolfSSL_Realloc(__FILE__, __LINE__, (ptr), (n))
        #else
