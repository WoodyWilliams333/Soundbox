...
enum {
	...
	RSA_BLOCK_TYPE_0 	= 0,
    RSA_BLOCK_TYPE_1 	= 1, //填充的方式不一样
    RSA_BLOCK_TYPE_2 	= 2,
	RSA_BLOCK_TYPE_2_FF = 3, //block type 为02，但填充使用0xFF	
...
WOLFSSL_API int  wc_RsaPublicDecrypt(const byte* in, word32 inLen, byte* out,
                                 word32 outLen, RsaKey* key, WC_RNG* rng);
WOLFSSL_API int  wc_RsaPublicEncrypt_Block(const byte* in, word32 inLen, byte* out, word32 outLen,
								 RsaKey* key, WC_RNG* rng, int blocktype);
WOLFSSL_API int  wc_RsaPublicDecrypt_Block(const byte* in, word32 inLen, byte* out, word32 outLen,
								 RsaKey* key, WC_RNG* rng, int blocktype);
WOLFSSL_API int  wc_RsaPrivateDecryptInline(byte* in, word32 inLen, byte** out,
                                        RsaKey* key);
WOLFSSL_API int  wc_RsaPrivateDecrypt(const byte* in, word32 inLen, byte* out,
                                  word32 outLen, RsaKey* key);
WOLFSSL_API int  wc_RsaPrivateEncrypt(const byte* in, word32 inLen, byte* out,
                                  word32 outLen, RsaKey* key);
WOLFSSL_API int  wc_RsaPrivateEncrypt_Block(const byte* in, word32 inLen, byte* out,
								  word32 outLen, RsaKey* key, int blocktype);
WOLFSSL_API int  wc_RsaPrivateDecrypt_Block(const byte* in, word32 inLen, byte* out,
								  word32 outLen, RsaKey* key, int blocktype);
