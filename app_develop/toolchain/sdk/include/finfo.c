...
#define SP_ADDRESS      (0x80f60000 + 0x000a0000)
#define LOAD_TYPE       0x5A76E3F1
#ifndef CFG_APP_STACK_SIZE
#define CFG_APP_STACK_SIZE 32*1024
#endif
#ifndef CFG_APP_NAME
...
static const UserFileInfo_t FileInfo SECTION(.FILEINFO) = {
    ...
    0x70008000,                          /* loadadd  notice: don't change                        */
    0x70008000 + 4,                      /* runadd   notice: don't change                        */
