...
#define list_for_each_entry_type(etype, pos, head, member)              \
                for (pos = list_entry((head)->next, etype, member);  \
                     prefetch(pos->member.next), &pos->member != (head);    \
                     pos = list_entry(pos->member.next, etype, member))
...
#define list_for_each_entry_safe_type(etype, pos, n, head, member)          \
                        for (pos = list_entry((head)->next, etype, member),  \
                            n = list_entry(pos->member.next, etype, member); \
                             &pos->member != (head);                    \
                             pos = n, n = list_entry(n->member.next, etype, member))
