...
$(LOCAL_BUILT_MODULE): PRIVATE_CPPFLAGS := $(LOCAL_CPPFLAGS)
...
$(LOCAL_BUILT_MODULE): PRIVATE_DISABLE_SYSROOT_FLAGS := $(TARGET_DISABLE_SYSROOT_FLAGS)
...
ifneq (,$(filter SHARED_LIBRARY EXECUTABLE EXECUTABLE_BINARY,$(call module-get-class,$(LOCAL_MODULE))))
...
#
# If this is an executable binary module
#
ifeq ($(call module-get-class,$(LOCAL_MODULE)),EXECUTABLE_BINARY)
$(LOCAL_BUILT_MODULE): PRIVATE_ABI := $(TARGET_ARCH_ABI)
$(LOCAL_BUILT_MODULE): PRIVATE_BUILD_EXECUTABLE := $(cmd-build-executable)
$(LOCAL_BUILT_MODULE): PRIVATE_BUILD_EXECUTABLE_BINARY := $(cmd-build-executable-binary)
$(LOCAL_BUILT_MODULE): $(LOCAL_OBJECTS)
	$(call host-echo-build-step,$(PRIVATE_ABI),Executable) "$(PRIVATE_NAME)"
	$(hide) $(PRIVATE_BUILD_EXECUTABLE)
	$(call host-echo-build-step,$(PRIVATE_ABI),Objcopy) "$(PRIVATE_NAME).bin"
	$(hide) $(PRIVATE_BUILD_EXECUTABLE_BINARY)
