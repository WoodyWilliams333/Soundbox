...
WOLFSSL_RSA *wolfSSL_PEM_read_RSAPublicKey(FILE *fp, WOLFSSL_RSA **x,
                                           pem_password_cb *cb, void *u);
WOLFSSL_API
int wolfSSL_PEM_write_RSAPublicKey(FILE *fp, WOLFSSL_RSA *x); //It will call xxxx_NP api, so 'x' should be a RSA  private key
WOLFSSL_API
int wolfSSL_PEM_write_RSAPublicKey_NP(FILE * fp, WOLFSSL_RSA * pri_rsa);
...
#define PEM_write_RSAPublicKey_NP   wolfSSL_PEM_write_RSAPublicKey_NP
