...
WOLFSSL_API void wolfSSL_X509_get_serialNumber_free(WOLFSSL_ASN1_INTEGER* a);
...
#ifdef RUN_C2_PLATFORM
typedef long long ANS1_INTEGER_RET_TYPE;  // sizeof(long) only 4 bytes !!!
#else
typedef long ANS1_INTEGER_RET_TYPE;
#endif
WOLFSSL_API ANS1_INTEGER_RET_TYPE wolfSSL_ASN1_INTEGER_get(const WOLFSSL_ASN1_INTEGER*);
...
/* when library do we built */
WOLFSSL_API const char* wolfSSL_lib_build_time(void);
...
WOLFSSL_API void* wolfSSL_GetRsaDecCtx(WOLFSSL* ssl);
    ...
    WOLFSSL_API int wolfSSL_enable_cert_sign_verify(int enable);
